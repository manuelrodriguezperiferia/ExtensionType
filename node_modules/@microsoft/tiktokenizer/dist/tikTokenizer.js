...
const bytePairEncode_1 = require("./bytePairEncode");
...
class TikTokenizer {
    ...
    init(bpeDict, specialTokensEncoder, regexPattern) {
        ...
        this.specialTokensRegex = new RegExp(Array.from(specialTokensEncoder.keys())
...
//# sourceMappingURL=tikTokenizer.js.map