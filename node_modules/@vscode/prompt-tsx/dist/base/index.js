...
exports.toVsCodeChatMessages = exports.renderPrompt = exports.PromptRenderer = exports.MetadataMap = exports.PromptElement = exports.UserMessage = exports.TextChunk = exports.SystemMessage = exports.PrioritizedList = exports.AssistantMessage = exports.Cl100KBaseTokenizer = exports.ChatRole = void 0;
...
Object.defineProperty(exports, "Cl100KBaseTokenizer", { enumerable: true, get: function () { return tokenizer_1.Cl100KBaseTokenizer; } });
...
async function renderPrompt(ctor, props, endpoint, tokenizer, progress, token, mode = 'vscode') {
